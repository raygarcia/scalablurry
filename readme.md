...
3. [An example](#example)
   ...
   3. [Results](#results)
4. [ToDo](#todo)
5. [wiki](https://github.com/raygarcia/scalablurry/wiki)
...
Usage (Please don't forget the quotes!):
    sbt 'run "..."'  where "..." = [OPTIONS] <FCL file>
*sbt interprets ';' as a separate command so the entire part afer "run" needs to be in double quotes as shown above.  There is also an example shown below.
...
#### The following example is of the use of Scalablurry as an executable jar
